...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/services/ai-websites-landing-pages', destination: '/services/acra', permanent: true },
      { source: '/services/real-time-analytics', destination: '/services/acra', permanent: true },
      { source: '/services/ai-readiness-check', destination: '/services/acra', permanent: true },

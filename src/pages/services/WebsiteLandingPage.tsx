  ...
  const benefits = [
    {
      ...
      title: "Sub-300ms Render Times",
      description: "SPA + SSR architecture delivers fully-rendered HTML in under 300ms—the threshold AI agents require for prioritization"
    },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      title: "Protocol-Native Design",
      description: "Built for UCP, ACP, and AP2 compliance with /.well-known/ucp manifests and heavy JSON-LD schema markup"
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: "Token-Efficient Architecture",
      description: "Eliminate the 'Hydration Tax' that legacy platforms impose—AI agents allocate more tokens to your actual content"
    },
    {
      icon: <BarChart3 className="h-6 w-6" />,
      title: "Agent-Ready Checkout",
      description: "Full UCP capability negotiation and ACP Instant Checkout integration for seamless AI-mediated transactions"
    }
  ];

  const features = [
    "SPA + SSR hybrid architecture for optimal AI crawler performance",
    "Heavy JSON-LD schema markup for all products, services, and entities",
    "UCP manifest publishing at /.well-known/ucp for agent discovery",
    "ACP checkout adapter for ChatGPT Instant Checkout compatibility",
    "AP2 mandate signing infrastructure for cryptographic transaction trust",
    "Real-time inventory APIs with 15-minute refresh cycles to prevent hallucinations"
  ];

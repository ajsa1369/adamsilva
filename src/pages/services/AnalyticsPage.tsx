  ...
  const benefits = [
    {
      ...
      title: "Agent Citation Tracking",
      description: "Monitor when AI engines cite your content—track ChatGPT, Gemini, and Perplexity mentions in real-time"
    },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      title: "Protocol Performance",
      description: "Measure UCP capability discovery rates, ACP checkout conversions, and AP2 mandate success metrics"
    },
    {
      icon: <Eye className="h-6 w-6" />,
      title: "Token Efficiency Score",
      description: "Track your site's token cost for AI crawlers—lower scores mean higher agent prioritization"
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: "Agentic Conversion Rate",
      description: "New metrics for AI-mediated transactions: agent checkout completion, mandate approval rates, execution times"
    }
  ];

  const features = [
    "AI citation tracking across ChatGPT, Gemini, Perplexity, and AI Overviews",
    "UCP capability negotiation analytics and discovery latency monitoring",
    "ACP checkout session tracking with conversion funnel analysis",
    "Token efficiency scoring for AI crawler optimization",
    "Agent-initiated transaction attribution and ROI measurement",
    "Real-time protocol compliance monitoring with automated alerts"
  ];

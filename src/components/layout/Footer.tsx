  ...
  const moreServices = [
    {
      ...
      path: '/services/outreach-partnerships',
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering businesses with intelligent, data-driven AI marketing
              solutions for customer engagement and sustainable growth.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/company/adamsilva-consulting"
                target="_blank"
              ...
              <a
                href="https://twitter.com/adamsilva_ai"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Adam Silva Consulting. All rights reserved.
            </p>

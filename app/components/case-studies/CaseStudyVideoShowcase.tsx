...
export function CaseStudyVideoShowcase() {
  ...
  useEffect(() => {
    import('../../../remotion/CaseStudy/CaseStudyVideo').then((mod) => {
      setVideoComponent(() => mod.CaseStudyVideo)
    })
  }, [])
  ...
  return (
    <section className="section relative overflow-hidden" aria-label="Visual Overview">
      <div
